...
<div class="nes-container with-title text-content">
    <p class="title">Lydia</p>
    <section class="nes-content">
        <div class="nes-text">
            <p>Lydia, c’est la convivialité, la solidarité entre étudiants et aussi la fin des galères. Avec Lydia, tu pourras rembourser tes potes en moins de deux secondes (exception faite si ta banque te demande un certicode pour 1 euro #experience). </p>
            <p>À l’INSA, on est moderne, on n’utilise plus d’espèces: tout se fait virtuellement. Du coup, Lydia te sert aussi à payer ton panini au foyer le midi (si tu le préfères au repas du Crous (le foyer dépend de l’Amicale, non pas du Crous, donc n’essaye pas de payer avec Izly (si tu as bien suivi le paragraphe précédent (trop de parenthèses on dirait le typage en algo)))). C’est aussi avec cette appli que tu vas réserver ta place pour le Gala, pour le I5, ou encore pour aller voir les Enfoiros (on compte sur toi). Comme pour Izly, tu peux générer un QR Code ou même payer seulement à l’aide du numéro (de tel) de ton poto.</p>
        </div>
        <img src="../assets/lydia_cartridge.png" style="max-height: 200px">
    </section>
