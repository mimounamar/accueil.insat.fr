...
<div class="nes-container with-title text-content">
    ...
    <section class="nes-content">
        ...
        <div class="nes-text">
            <p>Pendant cette semaine d’aventure Pokémon, ta blouse te sera indispensable: elle sera un peu comme ton Pokédex ! Au delà de d’être utile pendant tes séances de TPs, elle nous permettra de reconnaître le·la Peintre de Pokémon Acclamé·e en toi (vu que tu vas la porter sur toi pendant toute la semaine :D).</p>
...
<div class="nes-container with-title text-content">
    ...
    <section class="nes-content">
        <div class="nes-text-alt">
            ...
            <p>• Par toi-même décorer ta blouse, tu devras, l’aide de maman et mamie, tu ne demanderas donc pas. Eh oui, on y est tous passés, à ton tour maintenant.</p>
            ...
            <p>Voici le modèle ce que nous attendons :)</p>
...
<div class="nes-container with-title text-content">
    ...
    <section class="nes-content">
        <div class="nes-text-alt">
            <p>La blouse est un moyen de nous reconnaître entre promos, c’est un peu notre carte d’identité ! Tu devras donc teinter et décorer ta blouse aux couleurs de ton équipe : jaune, au cas où tu ne l’aurais toujours pas compris. Et qui sait, tu seras peut-être élu miss ou mister blouse !</p>
