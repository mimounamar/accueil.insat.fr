<?php
$TEAMS_ID = ['pkchu', 'salapeks', 'boombizar', 'carapalette'];
$TEAMS_DISPLAY_NAMES = [];
$TEAMS_DISPLAY_NAMES['pkchu'] = "PK'Chu";
$TEAMS_DISPLAY_NAMES['salapeks'] = "SalaPeks";
$TEAMS_DISPLAY_NAMES['boombizar'] = "Boom'Bizar";
$TEAMS_DISPLAY_NAMES['carapalette'] = "CapaPalette";

$TEAMS_DESCRIPTIONS = [];
$TEAMS_DESCRIPTIONS['pkchu'] = "
                <p>Si tu es ici, c'est que tu sais sûrement que tu fais partie de l'incroyable équipe des Pk'Chus.</p>
                <p>Aussi électriques que des piles à hydrogène, on est là pour gagner !</p>
                <p>Je suis Thomas, et en tant que Grand Dresseur Ancestral, je suis à ta disposition si tu as une quelconque question sur ta semaine ! Alors, n'hésite surtout pas à me contacter ;)</p>
                <p>En cas de besoin, voici mon adresse mail : <strong>bodoin@insa-toulouse.fr</strong></p>
                ...
                <p>Thomas BODOIN - Le président</p>";
...
$TEAMS_DESCRIPTIONS['carapalette'] = "
                ...
                <p>Profite à fond de cette semaine qui, j’espère, restera gravée dans ta mémoire pour de longues années et marquera ton entrée dans notre belle école (je te félicite au passage pour ton admission !)</p>
                <p>Fais le plein d’énergie, de soleil et de bonne humeur, je t’attends avec impatience !</p>
                <p>Nisma TAMIME - La secrétaire</p>";

$TEAM_COLORS = [];
$TEAM_COLORS['pkchu'] = "jaune";
